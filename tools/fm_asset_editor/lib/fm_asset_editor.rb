...
require_relative 'fm_asset_editor/mml/engine'
require_relative 'fm_asset_editor/mml/tune'
require_relative 'fm_asset_editor/mml/audio'
require_relative 'fm_asset_editor/mml/document'
require_relative 'fm_asset_editor/formats/basic_sheet'
require_relative 'fm_asset_editor/formats/sprite332'
require_relative 'fm_asset_editor/formats/mml_tune'
...
module FmAssetEditor
  ...
  Format.register(Formats::MmlTune)
  ...
  def self.require_ui
    ...
    require_relative 'fm_asset_editor/ui/mml_roll'
